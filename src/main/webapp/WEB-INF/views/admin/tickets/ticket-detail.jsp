                ...
                <form:form modelAttribute="ticket" method="post" action="${pageContext.request.contextPath}/admin/tickets/update/${ticket.id}">
                    ...
                    <div class="form-group">
                        ...
                        <form:select path="status" cssClass="form-control" required="true">
                            <form:option value="0" ${ticket.status == 0 ? 'selected' : ''}>Upcoming</form:option>
                            <form:option value="1" ${ticket.status == 1 ? 'selected' : ''}>Ongoing</form:option>
                            <form:option value="2" ${ticket.status == 2 ? 'selected' : ''}>Completed</form:option>
                        </form:select>
                    ...
                    <div class="form-group">
                        ...
                        <form:select path="type" cssClass="form-control" required="true">
                            <form:option value="offline" ${ticket.type == 'offline' ? 'selected' : ''}>Offline</form:option>
                            <form:option value="online" ${ticket.type == 'online' ? 'selected' : ''}>Online</form:option>
                            <form:option value="hybrid" ${ticket.type == 'hybrid' ? 'selected' : ''}>Hybrid</form:option>
                        </form:select>
