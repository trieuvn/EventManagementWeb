            ...
            <div class="col-lg-12 text-center">
                <div class="footer-text">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/about">SỰ KIỆN</a></li>
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/news">NGƯỜI THAM GIA</a></li>
                        <li class="list-inline-item"><a href="${pageContext.request.contextPath}/contacts">THỂ LOẠI</a></li>
                    </ul>
