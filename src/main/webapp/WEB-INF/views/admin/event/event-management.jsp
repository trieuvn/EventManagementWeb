        ...
        <main class="main-content">
            ...
            <section class="lower-panels">
                <div class="guests">
                    <div class="list-header">
                        <h2>Tổ chức</h2>
                        <form action="${pageContext.request.contextPath}/admin/organizers/create" method="get">
                            <button type="submit" class="btn-primary"><i class="fa fa-plus"></i> Tạo mới</button>
                        </form>
                    </div>
                    <table>
                        ...
                        <tbody>
                            <c:forEach var="organizer" items="${guestList}">
                                <tr>
                                    <td>${organizer.firstName} ${organizer.lastName}</td>
                                    <td>${organizer.email}</td>
                                    <td>${organizer.phoneNumber}</td>
                                    <td class="actions">
                                        <form action="${pageContext.request.contextPath}/admin/organizers/view/${organizer.id}" method="get">
                                            <button type="submit" class="btn-icon"><i class="fa fa-eye"></i></button>
                                        </form>
                                        <form action="${pageContext.request.contextPath}/admin/organizers/edit/${organizer.id}" method="get">
                                            <button type="submit" class="btn-icon"><i class="fa fa-edit"></i></button>
                                        </form>
                                        <form action="${pageContext.request.contextPath}/admin/organizers/delete/${organizer.id}" method="post">
                                            <button type="submit" class="btn-icon"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
